        ...
        <x-content.table-container>
            ...
            <div class="card-header py-3 d-sm-flex align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold mb-2" style="color: #722c75"><i class="fas fa-solid fa-circle-info"></i> Detail
                    Transaksi</h6>
                <div class="d-flex">
                    <a href="{{ route('admin.transaction-cashier.exportPdf', $transaction->id) }}"
                        class="d-sm-inline-block btn btn-sm btn-secondary shadow-sm mr-2">Cetak Nota</a>
                    <a href="{{ route('admin.transaction-cashier.index', ['cashier_id' => request('cashier_id'), 'start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
                        class="d-sm-inline-block btn btn-sm btn-warning shadow-sm">Kembali
                    </a>
                </div>
            </div>
