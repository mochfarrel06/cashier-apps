...
<x-sidebar.layout>
    ...
    <!-- Nav item carts -->
    <x-sidebar.nav-item title="Laporan" icon="fa-file" label="Laporan" collapseId="collapsePages" :routes="['admin.report-transaction.*', 'admin.report-detail.*', 'admin.sales-report.*']"
        :subItems="[
