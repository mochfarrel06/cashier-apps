<x-sidebar.layout>
    ...
    <x-sidebar.nav-item route="cashier.dashboard.index" icon="fa-tachometer-alt" label="Beranda" />
    ...
    <x-sidebar.nav-item title="Laporan" icon="fa-file" label="Laporan" collapseId="collapseItem" :routes="['cashier.transaction-report.*', 'cashier.income-report.*']"
        :subItems="[
